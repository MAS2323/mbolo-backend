...
const cartController = {
    ...
    try {
      ...
      if (cart) {
        ...
        if (!cart.products.includes(productId)) {
          ...
          await cart.save();
          cache.setCachedData(`cart_${userId}`, cart, 60000); // Actualiza la cache
        }
      } else {
        ...
        await newCart.save();
        cache.setCachedData(`cart_${userId}`, newCart, 60000); // Actualiza la cache
      }
  ...
  decrementCartItem: async (req, res) => {
    ...
    try {
      ...
      cache.setCachedData(`cart_${userId}`, cart, 60000); // Update cache
